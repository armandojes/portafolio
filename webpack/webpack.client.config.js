...
const config = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      BASEURL: JSON.stringify(process.env.NODE_ENV === 'production' ? '' : 'http://192.168.1.10:3000'),
      ASSETS: JSON.stringify(process.env.NODE_ENV === 'production' ? '' : 'http://192.168.1.10:3000/public'),
    })
  ],
  target: 'web',
}
